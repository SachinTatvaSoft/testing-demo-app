...
class MobileAccountLogin extends React.Component<Props, S, SS> {
  static MobileAccountLogin: MobileAccountLogin;
          ...
          >
            ...
            >
              ...
              >
                ...
                {this.renderMobilAccountNotFound()}
              </FormControl>
            </Container>
            <>
              <Box
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <span className={classes.labelTitle}>Login using mobile</span>
          {this.renderMobileLoginComponent()}
        </Container>
...
// @ts-ignore
export default withStyles(styles)(withRouter(MobileAccountLogin));
